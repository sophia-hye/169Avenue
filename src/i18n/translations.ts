export const translations = {
  en: {
    ...
    hero_tag2: 'Education System Translator',
    hero_h1_1: 'From Overseas',
    hero_h1_2: 'to Opportunity',
    hero_sub: 'IB, AP, GPA-based strategy — from global university admissions to Korean university entry, designed as one unified plan.',
    hero_bullet1: 'US / UK / EU / Asia — global university admissions strategy',
    hero_bullet2: 'Overseas HS → Korean top university (재외국민 / 외국인 전형)',
    hero_bullet3: 'Foreign university → Korean university transfer planning',
    hero_cta1: 'Free Diagnosis',
    hero_cta2: 'Book Consultation',
    hero_quote2: '"We don\'t recommend universities — we translate your education into strategy."',

    target_title: 'Choose the strategy that fits your path',
    target1_title: 'Global University Admissions',
    target1_b1: 'US / UK / EU / Asia — GPA + activity-based strategy',
    target1_b2: 'Essay, interview, and multi-country planning',
    target1_cta: 'Get Diagnosed',
    target2_title: 'Overseas HS → Korean University',
    target2_b1: 'IB / AP / GPA-based 학종 & international tracks',
    target2_b2: '재외국민 / 외국인 전형 strategy',
    target2_cta: 'Check Eligibility',
    target3_title: 'Foreign Univ → Korean Transfer',
    target3_b1: 'Credit-based feasibility analysis',
    target3_b2: 'Realistic transfer strategy design',
    target3_cta: 'Assess Transfer',

    problem_tag: 'Sound Familiar?',
    problem_title: 'If you have these questions, you\'re in the right place.',
    problem_items: [
      "I have IB/AP scores but don't know which universities I can realistically target.",
      "I'm at an overseas school and wondering if Korean universities are also an option.",
      "I have a GPA but no strategy — I don't know where to start.",
      "I'm considering transfer but need a realistic feasibility assessment.",
    ],
  ...
  ko: {
    ...
    hero_h1_1: 'From Overseas',
    hero_h1_2: 'to Opportunity',
    hero_sub: 'IB, AP, GPA 기반으로 글로벌 대학 진학부터 한국 대학 지원까지 하나의 전략으로 설계합니다.',
    hero_bullet1: '미국 / 영국 / 유럽 / 아시아 — 글로벌 대학 진학 전략',
    hero_bullet2: '해외고 → 한국 상위권 대학 (재외국민 / 외국인 전형)',
    hero_bullet3: '한국 학생 → 해외 대학 (미국/영국/유럽/아시아) 입시',
    hero_cta1: '무료 진단',
    hero_cta2: '상담 예약',
    hero_quote2: '"대학을 추천하지 않습니다. 당신의 학력을 전략으로 번역합니다."',

    target_title: '당신의 학력과 목표에 맞는 전략을 선택하세요',
    target1_title: '글로벌 대학 진학',
    target1_b1: '미국 / 영국 / 유럽 / 아시아 — GPA + 활동 기반 전략',
    target1_b2: '에세이, 면접, 다국가 지원 설계',
    target1_cta: '진단 받기',
    target2_title: '해외고 → 한국대',
    target2_b1: 'IB / AP 기반 학종 및 국제전형',
    target2_b2: '재외국민 / 외국인 전형 전략',
    target2_cta: '가능성 확인',
    target3_title: '해외대 → 한국대 편입',
    target3_b1: '학점 기반 가능성 분석',
    target3_b2: '현실적 편입 전략 설계',
    target3_cta: '편입 상담',

    problem_tag: '이런 고민, 혹시 하고 계신가요?',
    problem_title: '이런 질문이 있다면, 제대로 찾아오셨습니다.',
    problem_items: [
      'IB/AP 성적으로 어디까지 가능한지 모르겠어요',
      '해외고인데 한국 대학도 고려해야 할지 고민이에요',
      'GPA는 있는데 전략이 없는 상태예요',
