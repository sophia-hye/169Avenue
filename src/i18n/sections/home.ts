export const homeTranslations = {
  en: {
    ...
    destinations_page_title: 'International - Overseas Admissions',
    destinations_page_eyebrow: 'International Admissions Strategy',
    destinations_page_h1_1: 'Global University',
    destinations_page_h1_2: 'Application Strategy',
    destinations_page_intro: 'Select a region to see our application strategy, or filter by academic field to find the right universities for your profile.',
    destinations_all_regions: 'All Regions',
    destinations_global_rankings: 'Global Rankings',
    field_page_title: 'Fields of Study - University Rankings',
    field_page_eyebrow: 'Academic Excellence by Discipline',
    field_page_h1_1: 'Fields of',
    field_page_h1_2: 'Study',
    field_page_intro: 'Explore the world\'s top-ranked universities by academic discipline.',
    field_top_in: 'Top {count} in {name}',
    uni_not_found: 'University not found',
    uni_back_to_fields: 'Back to Fields',
    uni_top_rank: 'Top Rank',
    uni_key_facts: 'Key Facts',
    uni_total_students: 'Total Students',
    uni_annual_tuition: 'Annual Tuition',
    uni_room_board: 'Room & Board',
    uni_acceptance_rate: 'Acceptance Rate',
    uni_campus_gallery: 'Campus Gallery',
    uni_global_rankings_by_discipline: 'Global Rankings by Discipline',
    uni_rank_n: 'Rank #{n}',
    uni_pursue: 'Pursue {name}',
    uni_pursue_body: 'Our curators have deep expertise navigating the admissions process for this institution. Begin your private consultation today.',
    region_back_ap: 'Asia-Pacific Map',
    region_back_eu: 'Europe Map',
    region_back_uk: 'United Kingdom Map',
    region_back_us: 'United States Map',
    region_institution_singular: 'Institution',
    region_institution_plural: 'Institutions',
    region_featured_universities: 'featured universities',
    region_about: 'About {name}',
    region_key_highlights: 'Key Highlights',
    region_universities_h2: 'Universities',
    region_ranked_by: 'Ranked by institutional prestige',
    region_explore_other_countries: 'Explore Other Countries',
    region_explore_other_states: 'Explore Other States',
    region_explore_other_regions: 'Explore Other Regions',
    region_explore_other_nations: 'Explore Other Nations',
    region_in_top_100: 'in Top 100',
    region_in_top_rankings: 'in Top Rankings',
    region_of_top_ranked: '{count} of {total} top-ranked universities',
    region_interactive_map: 'Interactive Map',
    region_overview_label: 'Regional Overview',
    region_top_institutions: 'Top Institutions',
    region_top_10_institutions: 'Top 10 Institutions',
    region_browse_by_state: 'Browse by State',
    region_browse_by_nation: 'Browse by Nation',
    region_browse_by_country: 'Browse by Country',
    region_us_summary: '{count} Top Universities Across {states} States',
    region_uk_summary: '{count} Top Universities Across {nations} Nations',
    region_us_hint_idle: 'Click a state to view its top universities',
    region_uk_hint_idle: 'Hover over a nation, then click to explore its universities',
    region_eu_hint_idle: 'Click a country to explore its universities',
    region_hint_hover: '{name} — {count} universities — Click to explore',
    region_nation_institutions: '{name} Institutions',
    region_us_long: 'The United States remains the gold standard for higher education, housing eight Ivy League universities and the world\'s top research institutions. Our curators maintain deep, personal relationships with admissions committees across the eastern seaboard, the West Coast innovation corridor, and the Southern academic powerhouses.',
    region_uk_long: 'The United Kingdom offers an unparalleled depth of academic heritage. Oxford and Cambridge remain the pinnacle of intellectual rigour. The Russell Group universities provide world-class research environments, while London\'s institutions offer global connectivity.',
    region_eu_long: 'Continental Europe represents the convergence of centuries-old academic tradition with cutting-edge innovation. France\'s grandes ecoles, Switzerland\'s world-leading polytechnics, Germany\'s research universities, and Italy\'s design powerhouses each offer distinct pathways to excellence.',
    ...
    region_study_in: 'Study in {name}',
    region_study_in_body: 'Our curators will guide you through the admissions process for {name}\'s top institutions.',
  ...
  ko: {
    ...
    expertise_items: [
      ...
      { title: '비자 & 컴플라이언스', description: '복잡한 국제 규정을 원활하게 처리하여 스트레스 없는 유학 준비를 지원합니다.' },
    ],
    ...
    destinations_page_title: '해외 대학 진학 - International',
    destinations_page_eyebrow: '해외 입시 전략',
    destinations_page_h1_1: '글로벌 대학',
    destinations_page_h1_2: '지원 전략',
    destinations_page_intro: '지역을 선택해 지원 전략을 확인하거나, 분야로 필터링해 적합한 대학을 찾아보세요.',
    destinations_all_regions: '전체 지역',
    destinations_global_rankings: '글로벌 랭킹',
    field_page_title: '전공별 대학 순위 - Fields of Study',
    field_page_eyebrow: '분야별 학문 우수성',
    field_page_h1_1: '전공',
    field_page_h1_2: '분야',
    field_page_intro: '학문 분야별 세계 최상위 대학을 살펴보세요.',
    field_top_in: '{name} Top {count}',
    uni_not_found: '대학을 찾을 수 없습니다',
    uni_back_to_fields: '분야로 돌아가기',
    uni_top_rank: '최상위 순위',
    uni_key_facts: '주요 정보',
    uni_total_students: '전체 학생 수',
    uni_annual_tuition: '연간 학비',
    uni_room_board: '기숙사·식비',
    uni_acceptance_rate: '합격률',
    uni_campus_gallery: '캠퍼스 갤러리',
    uni_global_rankings_by_discipline: '분야별 글로벌 랭킹',
    uni_rank_n: '순위 #{n}',
    uni_pursue: '{name} 도전하기',
    uni_pursue_body: '저희 큐레이터는 이 대학의 입시 과정에 대한 깊은 전문성을 갖추고 있습니다. 비공개 상담을 시작해 보세요.',
    region_back_ap: '아시아-태평양 지도',
    region_back_eu: '유럽 지도',
    region_back_uk: '영국 지도',
    region_back_us: '미국 지도',
    region_institution_singular: '개 대학',
    region_institution_plural: '개 대학',
    region_featured_universities: '개 주요 대학',
    region_about: '{name} 소개',
    region_key_highlights: '주요 특징',
    region_universities_h2: '대학',
    region_ranked_by: '대학 위상 순',
    region_explore_other_countries: '다른 국가 둘러보기',
    region_explore_other_states: '다른 주 둘러보기',
    region_explore_other_regions: '다른 지역 둘러보기',
    region_explore_other_nations: '다른 지역 둘러보기',
    region_in_top_100: 'Top 100',
    region_in_top_rankings: '상위권',
    region_of_top_ranked: '상위 {total}개 중 {count}개 대학',
    region_interactive_map: '인터랙티브 지도',
    region_overview_label: '지역 개요',
    region_top_institutions: '주요 대학',
    region_top_10_institutions: 'Top 10 대학',
    region_browse_by_state: '주별로 보기',
    region_browse_by_nation: '지역별로 보기',
    region_browse_by_country: '국가별로 보기',
    region_us_summary: '{states}개 주 · 상위 {count}개 대학',
    region_uk_summary: '{nations}개 지역 · 상위 {count}개 대학',
    region_us_hint_idle: '주를 클릭하면 해당 주의 주요 대학을 볼 수 있습니다',
    region_uk_hint_idle: '지역에 마우스를 올리고 클릭해 대학을 둘러보세요',
    region_eu_hint_idle: '국가를 클릭해 대학을 둘러보세요',
    region_hint_hover: '{name} — {count}개 대학 — 클릭해서 보기',
    region_nation_institutions: '{name} 주요 대학',
    region_us_long: '미국은 고등 교육의 황금 표준으로, 8개 아이비리그 대학과 세계 최고 연구 기관들을 보유하고 있습니다. 저희 큐레이터는 동부 해안, 서부 혁신 회랑, 남부 학문 강자들의 입학사정 위원회와 깊은 개인적 관계를 유지하고 있습니다.',
    region_uk_long: '영국은 비할 데 없는 깊이의 학문 유산을 자랑합니다. 옥스퍼드와 케임브리지는 지적 엄격함의 정점을 지키며, 러셀 그룹 대학들은 세계 수준의 연구 환경을 제공하고, 런던의 대학들은 글로벌 연결성을 갖추고 있습니다.',
    region_eu_long: '대륙 유럽은 수 세기 학문 전통과 첨단 혁신이 만나는 곳입니다. 프랑스의 그랑제콜, 스위스의 세계적 공과대학, 독일의 연구 중심 대학, 이탈리아의 디자인 강자들이 각각 우수성으로 향하는 차별적 경로를 제공합니다.',
    region_ap_long: '아시아·태평양은 고등 교육의 지배적 세력입니다. 싱가포르·홍콩·서울·도쿄에는 서구 대학들과 견주는 기관들이 자리하고, 중국의 급속한 투자는 세계 수준의 시설을 만들어냈습니다. 호주와 뉴질랜드는 엄격한 학문 프로그램과 함께 뛰어난 삶의 질을 제공합니다.',
    region_study_in: '{name}에서 공부하기',
    region_study_in_body: '저희 큐레이터가 {name}의 최상위 대학 입시 과정을 안내해 드립니다.',
    ...
    target_split: [
      {
        ...
        bullets: ['부담 없는 짧은 세션', '재능 탐색 중심', '초기 방향 피드백'],
        href: '/services',
        cta: 'Discovery 보기',
        accent: 'bg-amber-100/70 text-amber-900',
        dot: 'bg-amber-500',
      },
      {
        ...
        bullets: ['단일 또는 듀얼 트랙', '비교 분석 리포트', '전략 상담 연결'],
        href: '/services',
        cta: 'Decision 보기',
        accent: 'bg-sky-100/70 text-sky-900',
        dot: 'bg-sky-600',
