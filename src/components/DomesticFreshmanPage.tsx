    ...
    <>
      ...
      <header className="px-6 md:px-16 max-w-screen-2xl mx-auto mb-16 md:mb-24">
        ...
        <h1 className="font-headline text-4xl md:text-6xl lg:text-7xl text-primary tracking-tighter leading-none mb-6">
          {t.fresh_h1_1} <br /><span className="italic">{t.fresh_h1_2}</span>
        </h1>
      ...
      <section className="px-6 md:px-16 max-w-screen-2xl mx-auto mb-20 md:mb-32">
        <div className="bg-surface-container-lowest p-8 md:p-16 shadow-sm">
          ...
          <p className="font-headline italic text-lg text-secondary mb-8">{t.domdet_after_consult}</p>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {t.fresh_results.map((r) => (
      ...
      {/* Target Audience */}
      <section className="px-6 md:px-16 max-w-screen-2xl mx-auto mb-20 md:mb-32">
        <h3 className="font-label text-[10px] uppercase tracking-widest text-secondary font-bold mb-6">{t.domdet_recommended_for}</h3>
        <ul className="space-y-4 max-w-2xl">
          {t.fresh_audience.map((item) => (
      ...
      <section className="bg-surface-container-low py-20 md:py-32 px-6 md:px-16">
        <div className="max-w-screen-2xl mx-auto">
          <span className="font-label text-[10px] uppercase tracking-[0.2em] text-secondary mb-4 block">{t.domdet_admission_tracks_eyebrow}</span>
          <h2 className="font-headline text-3xl md:text-4xl text-primary mb-12">{t.domdet_available_pathways}</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            {t.fresh_tracks.map((track) => (
      ...
      <section className="py-20 md:py-32 px-6 md:px-16 text-center bg-primary text-on-primary">
        <div className="max-w-3xl mx-auto">
          <h2 className="font-headline text-3xl md:text-5xl italic mb-8 md:mb-12 leading-tight">{t.fresh_cta_title}</h2>
...
export function DomesticFreshmanPage() {
  const { t } = useLanguage()
  usePageTitle(t.fresh_page_title)
  return (
