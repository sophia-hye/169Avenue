  ...
  const content = (
    <div className="max-w-3xl mx-auto px-6 md:px-0 py-16 md:py-24">
      <div className="mb-16">
        ...
        <h1 className="font-headline text-5xl md:text-6xl text-primary tracking-tight mb-4">{t.privacy_title}</h1>
        <p className="font-body text-sm text-on-surface-variant">{t.privacy_updated}</p>
      </div>

      <div className="space-y-14">
        {t.privacy_sections.map((s) => (
          <div key={s.title}>
