...
function MobileConsultation() {
  ...
  return (
    <div className="md:hidden">
      ...
      {/* Bottom Nav */}
      <nav className="fixed bottom-0 left-0 right-0 bg-surface/80 backdrop-blur-xl flex justify-around items-center px-4 py-3 z-50">
        ...
        <Link to="/consultation" className="flex flex-col items-center gap-1 text-secondary font-bold">
        ...
        <Link to="/partners" className="flex flex-col items-center gap-1 text-on-surface-variant/40">
          ...
          <span className="text-[9px] font-label uppercase tracking-widest">Agency</span>
        </Link>
      </nav>
    </div>
  )
