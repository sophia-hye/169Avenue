...
const CASES = [
  {
    ...
    strategy: 'Targeted top-tier Korean business programs through 재외국민 특별전형. Positioned AP coursework as equivalent rigor, crafted bilingual personal statement emphasizing cross-cultural leadership.',
    result: 'Strategy focused on SKY business schools with safety options at Sungkyunkwan and Hanyang.',
    color: 'bg-primary',
  ...
  },
  {
    ...
    strategy: 'Designed application around leadership narrative and community impact. Compensated for lack of AP with strong IB predicted scores and curated extracurricular portfolio.',
    result: 'Sungkyunkwan and Hanyang-focused strategy with TOPIK preparation plan.',
  ...
  },
  {
    ...
    result: 'Identified 5 target universities with spring/fall transfer windows and credit mapping.',
    color: 'bg-surface-container-low',
    textColor: 'text-primary',
  },
  {
