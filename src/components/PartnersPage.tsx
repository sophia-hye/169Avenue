...
function MobilePartners() {
  return (
    <div className="md:hidden">
      ...
      {/* Bottom Nav */}
      <nav className="fixed bottom-0 w-full bg-surface/80 backdrop-blur-xl z-50 border-t border-outline-variant/10">
        <div className="flex justify-around items-center py-3">
          <Link to="/destinations" className="flex flex-col items-center gap-1 text-on-surface-variant/50">
            <span className="material-symbols-outlined">school</span>
            <span className="text-[10px] font-label uppercase tracking-[0.1em]">Destinations</span>
          </Link>
          <Link to="/stories" className="flex flex-col items-center gap-1 text-on-surface-variant/50">
            <span className="material-symbols-outlined">auto_stories</span>
            <span className="text-[10px] font-label uppercase tracking-[0.1em]">Stories</span>
          </Link>
          <Link to="/field" className="flex flex-col items-center gap-1 text-on-surface-variant/50">
            <span className="material-symbols-outlined">edit_note</span>
            <span className="text-[10px] font-label uppercase tracking-[0.1em]">Fields</span>
          </Link>
          <Link to="/partners" className="flex flex-col items-center gap-1 text-secondary font-bold">
            <span className="material-symbols-outlined" style={{ fontVariationSettings: "'FILL' 1" }}>account_balance</span>
            <span className="text-[10px] font-label uppercase tracking-[0.1em]">Agency</span>
          </Link>
          <Link to="/consultation" className="flex flex-col items-center gap-1 text-on-surface-variant/50">
            <span className="material-symbols-outlined">mail</span>
            <span className="text-[10px] font-label uppercase tracking-[0.1em]">Contact</span>
          </Link>
        </div>
      </nav>
    </div>
